  ...
  var searchInterface = sajari.init({
      ...
      tabFilters: {defaultTab:"On this site",tabs:[{title:"On this site",filter:"domain='ssai.support.brightcove.com'"}, {title:"All Brightcove docs",filter:""}]}, // User selectable filters
