  ...
  var searchInterface = sajari.init({
      ...
      tabFilters: {defaultTab:"This Site",tabs:[{title:"This Site",filter:"domain='ssai.support.brightcove.com'"}, {title:"All Brightcove Documentation",filter:""}]}, // User selectable filters
